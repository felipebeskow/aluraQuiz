              ...
              >
                <input
                  ...
                  onClick={(infosDoEvento) => {
                    if (infosDoEvento.target.id.replace('alternative__', '') === question.answer.toString()) {
                      // eslint-disable-next-line no-alert
                      alert('Parabéns, resposta certa! :)');
                    } else {
                      // eslint-disable-next-line no-alert
                      alert('Que pena, não é essa :(');
                    }
                  }}
                />
                {alternative}
...
export default function QuizPage() {
  ...
  function handleSubmitQuiz() {
    ...
    if (nextQuestion < totalQuestions) {
      ...
      setTimeout(() => setScreenState(screenStates.QUIZ), 0.5 * 1000);
